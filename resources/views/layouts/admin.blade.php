...
<div class="row">
  <div class="col-sm-3 border rounded shadow p-3 ml-5">
    ...
    <h1 class="container-fluid text-center account-title">Admin Dashboard</h1>



<div class="container my-4">
  <ul class="list-group" id="menuList">
    <li class="list-group-item {{ Route::is('dashboard-admin') ? 'active' : '' }}">
      <a href="{{ route('dashboard-admin') }}" class="text-dark text-decoration-none">
    ...
    <li class="list-group-item {{ Route::is('dashboard-admin.products') ? 'active' : '' }}">
      <a href="{{ route('dashboard-admin.products') }}" class="text-dark text-decoration-none">
        <i class="fas fa-boxes mr-2"></i> Products
      </a>
    </li>
    <li class="list-group-item {{ Route::is('dashboard-admin.taxes') ? 'active' : '' }}">
      <a href="{{ route('dashboard-admin.taxes') }}" class="text-dark text-decoration-none">
        <i class="fas fa-shipping-fast mr-2"></i> Shipping + Taxes
      </a>
    </li>
    <li class="list-group-item {{ Route::is('dashboard-admin.prices') ? 'active' : '' }}">
      <a href="{{ route('dashboard-admin.prices') }}" class="text-dark text-decoration-none">
        <i class="fas fa-tags mr-2"></i> Prices
      </a>
    </li>
  </ul>
</div>
